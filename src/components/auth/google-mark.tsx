/**
 * โลโก้ G ของ Google ตามสีทางการ
 * เป็นข้อยกเว้นเดียวของกฎ "accent สีเดียว" ใน DESIGN.md — นี่คือเครื่องหมายการค้า
 * ที่ผู้ใช้ต้องจำได้ ไม่ใช่สีของ UI และ Google กำหนดให้ใช้สีชุดนี้บนพื้นสว่าง
 */
