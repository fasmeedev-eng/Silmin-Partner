  ...
  return (
    <section className="rounded-lg bg-parchment p-6 ring-1 ring-hairline ring-inset sm:p-8">
      ...
      {done ? (
        <p
          role="status"
          className="mt-5 flex items-center gap-2 rounded-md bg-canvas p-4 text-caption text-ink ring-1 ring-hairline ring-inset"
        >
      ...
      {canChangeStatus && options.length === 0 ? (
        <p className="mt-5 rounded-md bg-canvas p-4 text-caption text-ink-80 ring-1 ring-hairline ring-inset">
        ...
        <div className="mt-6 space-y-5 border-t border-hairline pt-6">
          <div>
            <label htmlFor="status-message" className="block text-body font-semibold text-ink">
              ข้อความถึงร้าน
              {needsMessage ? <span className="pl-1 text-accent-ink">*</span> : null}
            </label>
      ...
      <div className="mt-8 border-t border-hairline pt-6" hidden={!canWriteNotes}>
        ...
        <button
          ...
          className="mt-3 inline-flex min-h-[52px] items-center gap-2 rounded-full bg-canvas px-6 text-body text-ink ring-1 ring-hairline ring-inset transition-colors hover:bg-pearl disabled:opacity-50"
        >
      ...
      <dialog
        ...
        className="login-dialog m-auto w-[min(92vw,30rem)] rounded-lg bg-canvas p-0 text-ink backdrop:bg-black/50"
      >
        <div className="p-7">
          ...
          {to ? (
            <dl className="mt-5 space-y-3 rounded-md bg-pearl p-4 text-caption ring-1 ring-hairline ring-inset">
              <div>
